...
export const getCanvasContextSetting = (ctx: CanvasRenderingContext2D): CanvasContextSetting => {
  const { fillStyle, strokeStyle, lineWidth, globalAlpha } = ctx;
  return { fillStyle, strokeStyle, lineWidth, globalAlpha };
}

export const setCanvasContextSetting = (ctx: CanvasRenderingContext2D, canvasSetting: CanvasContextSetting): void => {
